...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.21/b-1.6.2/b-html5-1.6.2/b-print-1.6.2/datatables.min.css" />
...
<body id="page-top">
    <style>
        .bg-gradient-dark {
            ...
            background-image: linear-gradient(180deg, #343a40 10%, #343a40 100%);
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item"
                            href="http://cpanel.g2.develnet.net/cpsess8407639713/3rdparty/phpMyAdmin/index.php"
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-4 text-gray-800">Tabla de Casas de Alquiler - Ocupadas</h1>
                    <hr>
                    <p class="mb-4">Aqui se muestran todas las casas para alquilar que se encuentran ocupadas.</p>

            <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-black">Listado de Casas</h6>
            </div>
            <div class="card-body">

                <!-- TABLA -->
                          <table class="table table-hover dataTable no-footer" id="tablaTodas" > <!-- id es para ubicar la tabla con javascript-->
                              <div class="dropdown">
                            </div>
                              <br>
                            <thead>
                              ...
                              <th><center>Baños</center></th>
                              <th><center>Garage</center></th>
                              <th><center>Disponibilidad</center></th>
                              <th><center>Precio/Mes</center></th>
                            </thead>                            
                            <tbody align="center">
...
<script>
    ...
    $(document).ready(function(){ //cuando el doc esta listo se ejecuta la funcion
        var opcion;

        opcion= 2;
        
    tablaInq = $('#tablaTodas').DataTable({ //ubicamos con jquery la tabla por su id, usa las prop de datatable para ejecutar las proximas lineas
    	select: {
            style: 'multi',
            blurable: true
        },
   scrollY:400, //tamanio en relacion a la altura
    scrollX:true, 
    lengthMenu:[[10,25,50,-1],['de a 10','de a 25','de a 50','Todos']],//sete cantidad
    scrollCollapse: true,
    //ejecutamos un ajax para traer la info
        "ajax":{            
            "url": "../gestores/gestorCasasAlquiler.php", 
            "method": 'POST', //usamos el metodo POST
            "data":{opcion:opcion}, //opcion = 1 p/ luego usar en el switch
            "dataSrc":""
        },
        //si ajax devuelve succes muestra el sig resultado
        "success": function (res){
            console.log(res);
        }
        ,
        //setea todas las propiedades de respuesta en la colum correspondiente
        "columns":[
            {"data": "casa_id"},
        	{"data": "casa_direccion"},
        	{"data": "casa_habitaciones"},
            {"data": "casa_banios"},
            {"data": "casa_garage"},
            {"data": "casa_estado"},
            {"data": "casa_precioMes"},
