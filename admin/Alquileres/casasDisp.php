      ...
      <div id="content">
       ...
       <div class="container-fluid">
          ...
          <!-- Page Heading -->
            ...
            <h1 class="h3 mb-4 text-gray-800">Tabla de Casas de Alquiler - Disponibles</h1>
            <hr>
            <p class="mb-4">Aqui se muestran todas las casas para alquilar que se encuentran disponibles.</p>
